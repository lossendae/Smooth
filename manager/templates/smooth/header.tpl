...
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}min/?f={$_config.manager_url}templates/smooth/css/xtheme-modx.css,{$_config.manager_url}templates/smooth/css/index.css" />
{else}
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}assets/ext3/resources/css/ext-all-notheme-min.css" />
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}templates/smooth/css/xtheme-modx.css" />
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}templates/smooth/css/index.css" />
{/if}
...
<!--[if IE]>
<style type="text/css">body { behavior: url("{$_config.manager_url}templates/smooth/css/csshover3.htc"); }</style>
<link rel="stylesheet" type="text/css" href="{$_config.manager_url}templates/smooth/css/ie.css" />
<![endif]-->
</head>
    ...
    <div id="modx-mainpanel">
        <div id="modx-header">
           <div id="topbar">
			...
			<div id="nav">				
				<ul class="sf-menu">
					<li class="{$first_class}"><a href="javascript:;" onclick="MODx.loadPage('');">{$_lang.home}</a></li>
					{$navb}
				</ul>
			</div>
			<!-- End #nav -->
